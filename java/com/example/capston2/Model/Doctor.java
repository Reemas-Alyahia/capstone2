...
public class Doctor {
    ...
    public Doctor(Integer doctorId, String name, String username, String password, String email, Integer age, Boolean availability, Boolean apermit, Boolean active, String location) {
